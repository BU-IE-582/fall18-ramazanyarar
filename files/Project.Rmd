...
dt_season1<-dt_dataset[date>="2018-08-01"& date<="2018-12-24"][bookmaker=="Pinnacle"]
...
#model_data<-model_data[week<30]


model_data<-model_data[,c("matchId","leagueId","odd1","date","MatchResult","homeprob","awayprob","drawprob","AwayTotalGrade","HomeTotalGrade","homeL5rps","awayL5rps","Is.special")]
...
train.data<- model_data[date<"2018-12-25"] # 70% data goes in here 2018-12-03
test.data<- model_data[date>"2018-12-18"]  ## & date<"2018-12-25"]
...
```{r}
  ...
  dt_playedmatches<-dt_matches[date>="2018-12-18" & date<="2018-12-25"]
