...
library(pracma)
library (data.table)
dt_odds<- readRDS("~/Documents/Dersler/Fall-2018/IE-582/df9b1196-e3cf-4cc7-9159-f236fe738215_odd_details-5.rds")
...
dt_matches<-dt_matches[date>1470079297]# 1 A??utos 2017
...
dt_season1<-dt_dataset[date>="2018-08-01"& date<="2018-12-06"][bookmaker=="Pinnacle"]
...
model_data<-rbind(model_data_sz1,model_data_sz2,model_data_sz3)

model_data<-model_data[,c("matchId","leagueId","odd1","date","MatchResult","AwayTotalGrade","HomeTotalGrade","homeprob","drawprob","awayprob","homeOldRps","awayOldRps","homeL3wincount","homeL3defeatcount","awayL3wincount","awayL3defeatcount")]
         #                 "homeOldRps","awayOldRps", "homeL3wincount","awayL3wincount")]
        #                "homeL3wincount","homeL3defeatcount","awayL3wincount","awayL3defeatcount")]
      #                    ,"homeL3wincount","homeL3defeatcount","awayL3wincount","awayL3defeatcount")]


train.data<- model_data[date<"2018-09-01"] # 70% data goes in here 2018-12-03
test.data<- model_data[date>="2018-09-01"]
...
```{r}
  ...
  dt_playedmatches<-dt_matches[date<="2018-12-06" & date>="2018-09-01"]
