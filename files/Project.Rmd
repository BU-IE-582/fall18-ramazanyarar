...
library(pracma)
library (data.table)
dt_odds<- readRDS("~/Documents/Dersler/Fall-2018/IE-582/df9b1196-e3cf-4cc7-9159-f236fe738215_odd_details-2.rds")
dt_matches <- readRDS("~/Documents/Dersler/Fall-2018/IE-582/df9b1196-e3cf-4cc7-9159-f236fe738215_matches-2.rds")
...
dt_matches<-dt_matches[date>1470065598]
...
performance_analysis<-function(data){
  ...
  dt_performancesummary<-data[,mean(rps),by = .(bookmaker,week)]
...
model_data<-rbind(model_data_sz1,model_data_sz2)

model_data<-model_data[,c("matchId","leagueId","odd1","date","MatchResult","AwayTotalGrade","HomeTotalGrade","homeprob","drawprob","awayprob")]
                          ,"homeL3wincount","homeL3defeatcount","awayL3wincount","awayL3defeatcount")]


train.data<- model_data[date<"2018-12-03"] # 70% data goes in here
test.data<- model_data[date>"2018-12-03"]
...
predictions=train_glmnet(train_features, test_features, not_included_feature_indices=c(1:5), alpha=1,nlambda=10, tune_lambda=TRUE,nofReplications=1,nFolds=4,trace=T)
