...
dt_season1<-dt_dataset[date>="2018-08-01"& date<="2018-12-19"][bookmaker=="Pinnacle"]
...
fixture[,`:=`(WinProbratio = ifelse(Status == 0, homeprob/awayprob,awayprob/homeprob))]
...
model_data<-model_data[,c("matchId","leagueId","odd1","date","MatchResult","homeprob","drawprob","AwayTotalGrade","HomeTotalGrade","homeOldRps","awayOldRps")]
...
train.data<- model_data[date<"2018-12-15"] # 70% data goes in here 2018-12-03
test.data<- model_data[date>="2018-12-15"]
